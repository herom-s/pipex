...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/22 16:29:28 by hermarti          #+#    #+#             */
/*   Updated: 2025/10/22 16:29:43 by hermarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					validate_commands(char ***cmd_strs, char **bin_paths,
						char *argv[], unsigned int start_idx);
...
int					is_limiter_match(char *line, char *limiter,
						int limiter_len);
#endif
